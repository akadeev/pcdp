...
public final class ReciprocalArraySum {
    ...
    private static class ReciprocalArraySumTask extends RecursiveAction {
        ...
        ReciprocalArraySumTask(final int setStartIndexInclusive,
                final int setEndIndexExclusive, final double[] setInput, int chunks) {
        ...
        protected void compute() {
            ...
            if (length < SEQUENTIAL_THRESHOLD) {
                ...
                for (int i = 0; i < chunks; i++) {
                    int start = startIndexInclusive + getChunkStartInclusive(i, chunks, length);
                    int end = startIndexInclusive + getChunkEndExclusive(i, chunks, length);
                    ReciprocalArraySumTask task = new ReciprocalArraySumTask(start, end, input, chunks);
                    tasks.add(task);
                    task.fork();
                }
